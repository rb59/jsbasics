...
#|#|#|#|#|#|#|#|#|#|#|#|#|#|#|#|#|#|#|#|#|#|#|#|#|#|#|#|#|#|
    ...
    $Functions->RedireccionarSiNoHayPermiso("".NIVEL_MINIMO_PANEL."", "".HK."");
    $TplClass->SetParam('title', 'Agregar Cursos');
    $TplClass->SetParam('icon', '<i data-feather="book"></i>');
    $TplClass->SetParam('color', 'bg-gradient-primary-to-secondary-3');
    $TplClass->SetParam('desc', 'Aquí podrás agregar cursos a la página');
	...
	$TplClass->AddTemplate("manage","agregar_curso");
    //AÑADIMOS EL FOOTER

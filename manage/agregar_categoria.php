...
#|#|#|#|#|#|#|#|#|#|#|#|#|#|#|#|#|#|#|#|#|#|#|#|#|#|#|#|#|#|
    ...
    $TplClass->SetParam('title', 'Agregar Categoría');
    $TplClass->SetParam('icon', '<i data-feather="grid"></i>');
    $TplClass->SetParam('color', 'bg-gradient-primary-to-secondary-3');
    $TplClass->SetParam('desc', 'Aquí podrás agregar categorías a la página');
	...
	$TplClass->AddTemplate("manage","agregar_categoria");
    //AÑADIMOS EL FOOTER
